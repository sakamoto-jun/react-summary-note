  ...
  return (
    <div className="p-6 bg-zinc-900 rounded-lg">
      <div className="flex justify-between items-center">
        <div className="grow">
          <time className="block text-zinc-400 text-sm mb-2">{note.time}</time>
          <input
            type="text"
      ...
      <section className="flex mt-4">
        <div className="flex-1 p-4 mr-4 bg-zinc-800 rounded-xl">
          ...
          ></textarea>
          <button className="px-4 py-2 rounded bg-sky-600 hover:bg-sky-500 transition-colors">
            요약
          </button>
        </div>
        <div className="flex-1 p-4 bg-zinc-800 rounded-xl">
          <h3 className="mb-2 text-lg font-semibold">요약 결과</h3>
          <div className="h-64 p-2 rounded bg-zinc-700 text-zinc-300">
            {note.summary}
          </div>
        </div>
      </section>
